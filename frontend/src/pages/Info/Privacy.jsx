  ...
  return (
    ...
    >
      ...
      <InfoSection title="რა მონაცემებს ვაგროვებთ">
        ...
        <p>
          <strong className="font-semibold text-ink-900">რეგისტრაციისას:</strong> ელფოსტა და
          პაროლი, შენახული მისამართები, შეკვეთების ისტორია. პაროლს ვინახავთ მხოლოდ დაშიფრული
          სახით — ჩვენ ის არ ვიცით და ვერ ვნახავთ.
        </p>
        <p>
      ...
      <InfoSection title="ვის ვუზიარებთ">
        ...
        <p>
          ...
          მონაცემები არ იგზავნება — მხოლოდ შეკვეთის ნომერი და ჯამი.
        </p>
      </InfoSection>
      ...
      <InfoSection title="ბრაუზერში შენახული მონაცემები">
        <p>
          ...
          არჩევანს და შესვლის სესიას. სარეკლამო ან თვალთვალის cookie-ებს არ ვიყენებთ.
        </p>
      </InfoSection>
