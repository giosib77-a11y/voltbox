 ...
 *
 * header-ის ღილაკის ქვეშ (CategoryMenuButton) ყველა გვერდზეა, მთავარზე კი
 * hero-ს გვერდითაც დგას. ორივე ერთი და იგივე კომპონენტია.
 */
...
/**
 * „კატეგორიები“ ღილაკი header-ში (ყველა გვერდზე, მთავარზეც) — იმავე
