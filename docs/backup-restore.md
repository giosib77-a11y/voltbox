...
## რატომ არ არის საკმარისი Supabase-ის ავტომატური backup

Supabase-ის გეგმაზეა დამოკიდებული (Free-ზე retention მოკლეა ან საერთოდ არაა),
და ის **მათ ინფრასტრუქტურაშივე ცხოვრობს**. წაშლილი პროექტი backup-საც თან
წაიღებს. ქვემოთ აღწერილი dump შენს დისკზე რჩება.

⚠️ Dashboard-ში აუცილებლად შეამოწმე: **Database → Backups** — ჩართულია თუ არა
და რამდენ დღეს ინახება.
