...
ატარებს ტელეფონის ჩვეულებრივ 12 MP ფოტოს — JPEG 13.3 MP-მდე, PNG 8.9 MP-მდე,
WebP 2.6 MP-მდე — 24 MP-ს კი აღარ. გაზომილი პიკი თითოეულ ამ ზღვარზე: 90–92 MiB.

**2 GB-ის instance-ზე** (თუ 24 MP-ის ფოტოების ატვირთვა გინდა — iPhone 15–17
ნაგულისხმევად ამას იღებს):

```
MAX_IMAGE_DECODE_BYTES=201326592   # 192 MiB → JPEG 27.1 MP, PNG 19.6 MP, WebP 8.6 MP
```

გაზომილი პიკი ამ ზღვრებზე: 160–182 MiB. ჭერი 2 × 192 MiB ≈ 400 MB, worker-ებთან
ერთად ≈ 600 MB.
