...
- [ ] **10. Repo საჯაროა, ლიცენზიის გარეშე** — ეს ორი ცალკე კითხვაა:

      ლიცენზია:  ლიცენზიის არარსებობა ნიშნავს „ყველა უფლება დაცულია".
                 კომერციული მაღაზიისთვის ეს **სწორი ნაგულისხმევია** — MIT
                 ნებისმიერს მისცემდა უფლებას აეღო კოდი და გაეყიდა.
                 თუ portfolio-დ გინდათ — მაშინ MIT.
...
- [ ] **11. ლოკალური Postgres 16 → 17** — CI და production უკვე 17-ია.
